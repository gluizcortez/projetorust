-- Perfis de exemplo para EXECUÇÃO LOCAL.
--
-- Sem nenhum perfil, uma submissão é aceita, processada e termina em status 5
-- com zero recortes — o serviço funciona, mas não há o que observar. Estas
-- linhas dão ao ambiente local algo que casa.
--
-- As expressões estão SEM ACENTO de propósito: o texto indexado passa pela
-- remoção de diacríticos, e uma expressão acentuada nunca casa (INV-P19).
