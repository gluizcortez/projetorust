...
`)
	...
	b.WriteString("}\n")
	return os.WriteFile(saidaPalavra, []byte(b.String()), 0o600)
}
...
`)
	...
	b.WriteString("}\n")
	return os.WriteFile(saidaDiacriticos, []byte(b.String()), 0o600)
}
...
`)
	...
	b.WriteString("}\n")
	return os.WriteFile(saidaAlfanum, []byte(b.String()), 0o600)
}
