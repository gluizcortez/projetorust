// O roteador e o servidor HTTP: as rotas, a cadeia de middleware e os tempos
// limite com que o `http.Server` é construído.
package httpapi
...
import (
	...
	"github.com/gluizcortez/projetorust/src/middleware"
	"github.com/gluizcortez/projetorust/src/resposta"
